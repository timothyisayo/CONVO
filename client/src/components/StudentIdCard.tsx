...
type Props = { nickname: string; displayName: string; studentId: string; programme: string; college: string; level: string; visibility?: { programme: boolean; college: boolean; level: boolean } };
export const StudentIdCardVisibilityContext = React.createContext<{ programme: boolean; college: boolean; level: boolean }>({ programme: true, college: true, level: true });

export function StudentIdCard({ nickname, displayName, studentId, programme, college, level, visibility }: Props) {
