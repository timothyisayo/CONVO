...
vi.mock("@/lib/supabase", () => ({
  ...
  listMtuNotifications: vi.fn(async () => ({ data: [], error: null })),
  markMtuNotificationRead: vi.fn(async () => ({ data: null, error: null })),
  clearMtuNotifications: vi.fn(async () => ({ data: null, error: null })),
  subscribeToMtuNotifications: vi.fn(() => () => undefined),
}));
